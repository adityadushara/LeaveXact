            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="relative my-4">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white px-2 text-gray-400 font-semibold tracking-wider">Demo Accounts</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                <button
                  ...
                  onClick={() => {
                    setValue("role", "admin")
                    setValue("email", "admin@leavexact.com")
                    setValue("password", "admin@123")
                  }}
                  className="flex flex-col items-start p-3 text-left rounded-xl border border-gray-200 hover:border-emerald-500 hover:bg-emerald-50/50 transition-all hover:shadow-sm"
                >
                  <span className="text-xs font-semibold text-emerald-700 mb-1">Admin Portal</span>
                  <span className="text-[11px] text-gray-500 font-mono truncate w-full">admin@leavexact.com</span>
                  <span className="text-[10px] text-gray-400 font-mono mt-0.5">Password: admin@123</span>
                </button>
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setValue("email", "sarah@leavexact.com")
                    setValue("password", "employee@123")
                  }}
                  className="flex flex-col items-start p-3 text-left rounded-xl border border-gray-200 hover:border-emerald-500 hover:bg-emerald-50/50 transition-all hover:shadow-sm"
                >
                  <span className="text-xs font-semibold text-emerald-700 mb-1">Employee (Sarah)</span>
                  <span className="text-[11px] text-gray-500 font-mono truncate w-full">sarah@leavexact.com</span>
                  <span className="text-[10px] text-gray-400 font-mono mt-0.5">Password: employee@123</span>
                </button>
              </div>
            </form>
          </CardContent>
