                      ...
                      <CardContent className="space-y-4">
                        ...
                        <div className="pt-3 border-t">
                          ...
                          {(() => {
                            ...
                            const remaining = getTotalLeaveBalance(employee.leaveBalance, employee.gender)
                            const used = totalAllocated - remaining
                            const pct = totalAllocated > 0 ? Math.round((used / totalAllocated) * 100) : 0
                            return (
                              <div className="mt-3 space-y-1">
                                <div className="flex justify-between text-xs">
                                  <span className="text-gray-500">Utilization</span>
                                  <span className={`font-semibold ${pct >= 70 ? 'text-red-600' : pct >= 40 ? 'text-yellow-600' : 'text-green-600'}`}>
                                    {pct}%
                                  </span>
                                </div>
