                            ...
                            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="relative">
                                        <div className="h-16 w-16 md:h-20 md:w-20 bg-gray-200 rounded-full animate-pulse" />
                                        <div className="absolute -bottom-1 -right-1 h-6 w-6 bg-gray-200 rounded-full animate-pulse" />
                                    </div>
